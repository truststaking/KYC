...
@objc open class IdenfyProviderLoginViewUISettingsV2: NSObject {
    ...
    public static var idenfyProviderLoginViewUsernameInputViewHintTextColor = IdenfyCommonColors.idenfySecondColorV2?.withAlphaComponent(0.4)
    public static var idenfyProviderLoginViewPasswordInputViewHintTextColor = IdenfyCommonColors.idenfySecondColorV2?.withAlphaComponent(0.4)
