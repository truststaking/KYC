...
@objc open class IdenfyManualReviewingStatusFailedViewUISettingsV2: NSObject {
    ...
    public static var idenfyManualReviewingStatusFailedCommonInformationDescriptionEmailTextColor = IdenfyCommonColors.idenfyMainColorV2
    ...
    public static var idenfyManualReviewingStatusFailedCommonInformationDescriptionEmailFont = UIFont(name: ConstsIdenfyFonts.idenfyFontBoldV2, size: 15)
}
